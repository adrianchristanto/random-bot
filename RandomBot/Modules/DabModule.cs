...
namespace RandomBot.Modules
{
    public class DabModule : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task Dab()
        {
            ...
            this.ImageManipulation.ManipulateImage("Dab.jpg", Context.User.AvatarId, 163, 145, "Dab.jpg");
            await Context.Channel.SendFileAsync(@"Image\ToUpload\Dab.jpg");
            File.Delete(@"Image\ToUpload\Dab.jpg");
        }
    }
}
